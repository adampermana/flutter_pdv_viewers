...
/** FlutterPdvViewersPlugin */
public class FlutterPdvViewersPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
  private static final String TAG = "PdfViewersPlugin";

  private Handler backgroundHandler;
  private final Object pluginLocker = new Object();
  private final String filePrefix = "FlutterPluginPdfViewers";
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
    channel = new MethodChannel(binding.getBinaryMessenger(), "flutter_pdv_viewers");
  ...
  public void onMethodCall(@NonNull final MethodCall call, @NonNull final Result result) {
    synchronized (pluginLocker) {
      if (backgroundHandler == null) {
        HandlerThread handlerThread = new HandlerThread("flutterPdfViewers", Process.THREAD_PRIORITY_BACKGROUND);
        handlerThread.start();
